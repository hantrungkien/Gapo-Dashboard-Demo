...
import com.kienht.gapo.dashboard.databinding.NewsFeedStoryItemBinding
...
class StoryAdapter(private val viewLifecycleOwner: LifecycleOwner) :
    ...
    override fun getItemViewType(position: Int): Int = R.layout.news_feed_story_item
    ...
    inner class StoryViewHolder(
        ...
        override fun onViewRecycled() {
            ...
            if (binding is NewsFeedStoryItemBinding) {
